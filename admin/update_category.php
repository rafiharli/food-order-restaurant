    ...
    <div class="wrapper">
        ...
        <?php
            ...
            if(isset($_GET['id']))
            {
                ...
                {
                    $_SESSION['no_cat'] = "<div class='failed'>Category not Found.</div>";
        ...
        <?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    {   
                        ...
                        if($current_image!="")
                        {
                            ...
                            if($remove==FALSE)
                            {
                                $_SESSION['remove_fail'] = "<div class='failed'>Failed to remove current image.</div>";
                                header('location:'.SITEURL.'admin/manage_category.php');
                                die();
                            }
                        }
                ...
                if($res0==TRUE)
                {
                    $_SESSION['update'] = "<div class='success'>Category Update Succeed.</div>";
                    header('location:'.SITEURL.'admin/manage_category.php');
                }
                else
                {
                    $_SESSION['update'] = "<div class='failed'>Category Update Succeed</div>";
                    header('location:'.SITEURL.'admin/manage_category.php');
                }
            }
        ?>
